...
Esta vista proporciona un desglose detallado de los eventos de conversión que elige medir en formato de tabla. Los resultados se calculan en el nivel **ID de campaña**. La tabla incluye:

* **Evento de conversión**: Nombre de cada evento de conversión que está rastreando.
* **Recuento de conversiones**: Recuento total de conversiones que se produjeron para cada evento, para el identificador de campaña.
* **Valores de conversión**: Valor atribuido a cada evento de conversión, para el ID de campaña.
...
### Conversiones por ubicación {#conversions-by-placement}

Esta tabla proporciona un **desglose de nivel de ID de ubicación** de los eventos de conversión seleccionados para el informe de atribución. Un solo ID de campaña puede incluir varios ID de ubicación, por lo que debe utilizar esta vista para ver cómo se desglosan las conversiones dentro de una campaña. Para cada evento de conversión seleccionado, la tabla muestra las conversiones atribuidas a cada ubicación y el valor de conversión correspondiente. La tabla incluye:

* **Nombre o ID de la ubicación**: El identificador de la ubicación donde se ejecutó el elemento creativo.
* **Recuento de conversiones**: El recuento de conversiones atribuidas a esa ubicación, para cada evento de conversión seleccionado cuando se creó el informe. Una ubicación puede mostrar hasta tres eventos de conversión, que coinciden con el número máximo de eventos de conversión permitidos por informe.
* **Valor de conversión**: El valor atribuido a cada evento de conversión, para esa ubicación específica.

![Conversiones por ubicación.](/help/assets/collaborate/measure/conversions-by-placement.png)
