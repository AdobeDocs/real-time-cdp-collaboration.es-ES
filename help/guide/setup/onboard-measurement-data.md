...
>abstract="Marcador de posición para la asignación de medición de campos de origen."

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_import_measurement_mapping_target_fields"
>title="Asignar campos de destino"
>abstract="Marcador de posición para la asignación de medición de campos de destino."
