...
description: Aprenda a utilizar Adobe Real-Time Customer Data Platform (CDP) Collaboration para detectar, activar y medir públicos de alto valor sin depender de cookies de terceros.
