...
### Activar (en colaboración)

Hace referencia a la acción de enviar una audiencia a otro colaborador dentro de un proyecto compartido. Cuando activa una audiencia a un colaborador, esta se envía al destino preconfigurado de ese colaborador, donde está disponible para su uso en campañas. Para obtener instrucciones, consulte [Activar audiencias](/help/guide/collaborate/activate.md). No debe confundirse con **Activar (en un destino)**.

### Activar (en un destino)

Hace referencia al destino al que llega una audiencia activada, como una plataforma de almacenamiento en la nube o Adobe Experience Platform, y al espacio de trabajo donde se configuran, exploran y supervisan los destinos. Las audiencias siguen llegando a un destino a través de la acción [Activar audiencias](/help/guide/collaborate/activate.md) de un proyecto; este espacio de trabajo controla qué destinos están disponibles y cómo se configuran. Para obtener instrucciones, consulte [Información general sobre destinos](/help/guide/destinations/overview.md). No debe confundirse con **Activar (a colaborador)**.
